...
import { FaEnvelopeOpen, FaPhoneSquareAlt, FaFacebookF, FaTwitter, FaYoutube, FaInstagram, } from 'react-icons/fa';
          ...
          <div className="contact__info">
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">tanveershahveer@gmail.com</h4>
              </div>
            </div>
            ...
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">+92 3554330721</h4>
              </div>
            </div>
